...
class _Composer extends StatelessWidget {
  ...
  // Adjuntar fotos no existe todavía en el backend (ThreadsRepository solo
  // manda texto) — los íconos están por fidelidad visual, pero avisan en
  // vez de simular que hacen algo.
